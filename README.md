...
Algunos componentes más usados en el preprocesador son: **identificadores**, **eliminación de identificadores**, **compilación condicional**, **generación de avisos y errores** entre otros.

# Identificadores
Un identificador será una secuencia de cualquier número de
caracteres alfanuméricos –incluidas vocales acentuadas y eñes- tales que el primero de ellos no sea un número. Entre los identificadores usados en este código se encuentran: 
